           ...
           <div class="container">
             <div class="reg">
               <h2 class="display-4">Register Here
                <a href="{{ URL::to('interns') }}"><button class="btn btn-md btn-primary pull-xs-right">  View Tezza Interns Biodata
                 </button></a>
             </h2>
...
<div class="btns pull-xs-right">
  ...
  {{ Form::submit('Create Intern!', ['class' => 'btn btn-primary']) }}
</div>
